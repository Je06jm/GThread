...
namespace gthread::__impl {
    ...
    // See more here: https://en.wikipedia.org/wiki/X86_calling_conventions#Caller_clean-up
    class x86_gthread : public gthread {
    public:
        x86_gthread(Function function, void* user_params, size_t stack_size, bool is_setup) : gthread{function, user_params, stack_size, is_setup} {}
    ...
    private:
        ...
        void platform_setup() override {
            ...
            platform_ctx.esp = reinterpret_cast<uint32_t>(stack.get()) + static_cast<uint32_t>(stack_size);
            platform_ctx.esp -= 12;
